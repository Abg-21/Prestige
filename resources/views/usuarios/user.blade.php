    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                @if (App\Helpers\PermissionHelper::hasPermission('usuarios', 'crear'))
                <a href="{{ route('usuarios.create') }}" class="btn btn-success mb-3 ajax-link">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($usuario->eliminado_en)
                                        ...
                                        <small class="text-muted d-block">{{ $usuario->eliminado_en->format('d/m/Y H:i') }}</small>
                                    @else
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('usuarios.edit', $usuario->id) }}" 
                                           ...
                                           @if(!App\Helpers\PermissionHelper::hasPermission('usuarios', 'editar')) disabled @endif>
                                            <i class="fas fa-edit"></i> Editar
                                        </a>
                                        
                                        @if(!$usuario->eliminado_en)
                                            @if (App\Helpers\PermissionHelper::hasPermission('usuarios', 'eliminar'))
                                            <button type="button" 
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    $.get("{{ route('usuarios.index') }}", function(html) {
