...
<?php $__env->startSection('title', 'Crear Candidato'); ?>
...
<div style="width: 100%; background: #fff; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); padding: 32px; margin: 0;">
    ...
    <form id="form-crear-candidato" action="<?php echo e(route('candidatos.store')); ?>" method="POST" autocomplete="off">
        <?php echo csrf_field(); ?>
            ...
            <div style="display: flex; gap: 10px; align-items: flex-end;">
                <div style="flex: 1;">
                    <select id="selectPuesto" name="IdPuestoCandidatoFK" style="width: 100%;">
                        <?php echo $__env->make('puestos.lista', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </select>
                </div>
        ...
        <div style="display: flex; justify-content: flex-end; gap: 10px; margin-top: 28px;">
            <a href="<?php echo e(route('candidatos.index')); ?>" class="btn btn-danger ajax-link" style="padding: 8px 20px; background: #e74c3c; color: #fff; border-radius: 4px; text-decoration: none;">Cancelar</a>
        ...
        success: function(response) {
            ...
            if ($('#main-content-overlay').length > 0) {
                ...
                if (typeof response === 'string' && response.includes('Candidatos') && response.length > 500) {
                    ...
                    $.get("<?php echo e(route('candidatos.index')); ?>", function(html) {
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('candidatos.index')); ?>";
                        }, 1500);
                    });
                }
            } else {
...
$(document).on('click', '#btnNuevoPuesto', function() {
    $.get("<?php echo e(route('puestos.create')); ?>?modal=true", function(html) {
...
$(document).on('submit', '#form-crear-puesto', function(e) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $.ajax({
                url: "<?php echo e(route('puestos.options')); ?>",
                type: 'GET',
                cache: false,
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Prestige\resources\views/candidatos/create_candidatos.blade.php ENDPATH**/ ?>