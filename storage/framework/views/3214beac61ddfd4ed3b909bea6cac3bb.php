<div style="width: 100%; max-width: 700px; margin: 40px auto; background: #fff; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); padding: 32px;">
    ...
    <form id="form-editar-giro" action="<?php echo e(route('giros.update', $giro->idGiros)); ?>" method="POST" autocomplete="off">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>

        <div style="margin-bottom: 22px;">
            <label for="Nombre" style="font-weight: bold;">Nombre:</label>
            <input type="text" name="Nombre" id="Nombre" value="<?php echo e(old('Nombre', $giro->Nombre)); ?>" required class="form-control" style="margin-top: 6px;">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="margin-bottom: 22px;">
            ...
            <textarea name="Descripcion" id="Descripcion" class="form-control" style="margin-top: 6px;"><?php echo e(old('Descripcion', $giro->Descripcion)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="display: flex; justify-content: center; gap: 18px; margin-top: 32px;">
            <a href="<?php echo e(route('giros.index')); ?>" class="btn btn-danger ajax-link" style="padding: 8px 28px;">Cancelar</a>
...
<?php /**PATH C:\xampp\htdocs\Prestige\resources\views/giros/edit_giro.blade.php ENDPATH**/ ?>