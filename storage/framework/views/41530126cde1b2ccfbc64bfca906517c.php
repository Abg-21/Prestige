<div style="padding: 20px;">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between;">
        <h2 style="margin-bottom: 20px; display: flex; align-items: center;">
            Empleados
            <?php if(App\Helpers\PermissionHelper::hasPermission('empleados', 'crear')): ?>
            <a href="<?php echo e(route('empleados.create')); ?>" class="ajax-link" style="margin-left: 15px; display: inline-flex; align-items: center;" title="Agregar empleado">
    ...
    <table style="width:100%; border-collapse: collapse; background: #fff;">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empleado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td style="padding: 8px; border: 1px solid #ddd;"><?php echo e($empleado->Nombre); ?></td>
                    <td style="padding: 8px; border: 1px solid #ddd;"><?php echo e($empleado->Apellido_Paterno); ?></td>
                    <td style="padding: 8px; border: 1px solid #ddd;"><?php echo e($empleado->Apellido_Materno); ?></td>
                    <td style="padding: 8px; border: 1px solid #ddd;"><?php echo e($empleado->Estado ?? 'N/A'); ?></td>
                    <td style="padding: 8px; border: 1px solid #ddd;"><?php echo e($empleado->Fecha_Ingreso ?? 'N/A'); ?></td>
                        <td class="text-center">
                            <div style="display: flex; justify-content: space-around; gap: 12px;">
                                ...
                                <a href="<?php echo e(route('empleados.show', $empleado->IdEmpleados)); ?>" 
                                   class="ajax-link"
                                ...
                                <?php endif; ?>
                                <?php if(App\Helpers\PermissionHelper::hasPermission('empleados', 'editar')): ?>
                                <a href="<?php echo e(route('empleados.edit', $empleado->IdEmpleados)); ?>" 
                                   class="ajax-link"
                                   style="background: none; padding: 5px; cursor: pointer; display: flex; flex-direction: column; align-items: center; text-decoration: none;">
                                ...
                                <?php endif; ?>
                                <?php if(App\Helpers\PermissionHelper::hasPermission('empleados', 'eliminar')): ?>
                                <button type="button" 
                                        onclick="confirmarDesactivacion(<?php echo e($empleado->IdEmpleados); ?>, '<?php echo e(addslashes($empleado->Nombre . ' ' . $empleado->Apellido_Paterno)); ?>')"
                                        style="background: none; border: none; padding: 5px; cursor: pointer; display: flex; flex-direction: column; align-items: center;">
                                    <img src="<?php echo e(asset('images/eliminar.png')); ?>" alt="Desactivar" style="width: 32px; height: 32px;">
...
<?php /**PATH C:\xampp\htdocs\Prestige\resources\views/empleados/empleado.blade.php ENDPATH**/ ?>