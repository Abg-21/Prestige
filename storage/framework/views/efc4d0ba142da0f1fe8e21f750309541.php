<div style="width: 100%; max-width: 900px; margin: 40px auto; background: #fff; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); padding: 32px;">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 18px;">
            <div style="display: flex; align-items: center;">
                ...
                <a href="<?php echo e(route('giros.create')); ?>" class="ajax-link" style="margin-left: 15px; display: inline-flex; align-items: center;" title="Crear Nuevo Giro">
                    <?php if(App\Helpers\PermissionHelper::hasPermission('giros', 'crear')): ?>
                    <img src="<?php echo e(asset('images/agregar-usuario.png')); ?>" alt="Agregar" style="width: 28px; height: 28px; vertical-align: middle;">
                    <?php endif; ?>
                </a>
            </div>
        </div>
        <?php if($giros->isEmpty()): ?>
            ...
            <div style="overflow-x: auto;">
                <table style="width:100%; border-collapse: collapse; background: #fff; border-radius: 8px; overflow: hidden;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="padding: 10px; border: 1px solid #ddd;"><?php echo e($giro->idGiros); ?></td>
                            <td style="padding: 10px; border: 1px solid #ddd;"><?php echo e($giro->Nombre); ?></td>
                            <td style="padding: 10px; border: 1px solid #ddd;"><?php echo e($giro->Descripcion); ?></td>
                            <td style="padding: 10px; border: 1px solid #ddd;">
                                <div style="display: flex; gap: 18px; justify-content: center;">
                                    <a href="<?php echo e(route('giros.edit', $giro->idGiros)); ?>" class="ajax-link" style="text-align: center;">
                                    ...
                                    <button type="button"
                                        <?php if(App\Helpers\PermissionHelper::hasPermission('giros', 'eliminar')): ?>
                                        <button type="button"
                                            class="btn-eliminar-giro"
                                            data-id="<?php echo e($giro->idGiros); ?>"
        ...
        <div style="margin-top: 18px; color: #e67e22; background: #fffbe6; border-radius: 8px; padding: 16px; font-weight: bold;">
            ...
            <?php if(session('giroIdError')): ?>
                <button 
                    type="button" 
                    onclick="confirmDelete(<?php echo e(session('giroIdError')); ?>)"
...
$(document).on('click', '#btn-confirmar-eliminar-giro', function(e) {
    ...
    $.ajax({
        url: "<?php echo e(url('giros')); ?>/" + giroIdPendiente,
        type: 'POST',
        data: {
        ...
        success: function(response) {
            ...
            if (response.success) {
                ...
                setTimeout(function() {
                    $.get("<?php echo e(route('giros.index')); ?>", function(html) {
...
<?php /**PATH C:\xampp\htdocs\Prestige\resources\views/giros/giro.blade.php ENDPATH**/ ?>