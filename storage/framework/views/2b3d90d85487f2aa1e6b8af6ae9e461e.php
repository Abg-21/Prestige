...
<div style="padding: 20px;">    header('Expires: 0');    header('Expires: 0');
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px;">@endphp@endphp
        ...
        <h2 style="margin: 0; color: #333;">
            ...
            <small style="font-size: 12px; color: #666;">(v3.1 - <?php echo e(now()->format('H:i:s')); ?>)</small>
        ...
        <div style="display: flex; gap: 10px;">
            ...
            <button id="generar-reporte" class="btn btn-info" style="padding: 8px 16px;">            📋 Control de Asistencia - <?php echo e($periodo === 'primera_quincena' ? 'Primera Quincena' : 'Segunda Quincena'); ?>            📋 Control de Asistencia - <?php echo e($periodo === 'primera_quincena' ? 'Primera Quincena' : 'Segunda Quincena'); ?>


                📊 Generar Reporte

            </button>            <small style="font-size: 12px; color: #666;">(v3.0 - <?php echo e(now()->format('H:i:s')); ?>)</small>            <small style="font-size: 12px; color: #666;">(v2.2 - <?php echo e(now()->format('H:i:s')); ?>)</small>
        ...
        <div style="display: flex; gap: 15px; align-items: center; flex-wrap: wrap;">                
            ...
            <div>        <div style="display: flex; gap: 10px;">        <div style="display: flex; gap: 10px;">
                ...
                <select id="estado-select" style="padding: 5px; min-width: 150px;">            <button id="guardar-asistencia" class="btn btn-success" style="padding: 8px 16px;">            <button id="guardar-asistencia" class="btn btn-success" style="padding: 8px 16px;">
                    ...
                    <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $est): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                💾 Guardar Asistencia                💾 Guardar Asistencia

                        <option value="<?php echo e($est); ?>" <?php echo e($estado === $est ? 'selected' : ''); ?>><?php echo e($est); ?></option>

                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>            </button>            </button>
                        ...
                        <button id="generar-reporte" class="btn btn-info" style="padding: 8px 16px;">            <button id="generar-reporte" class="btn btn-info" onclick="descargarReporteDirecto()" style="padding: 8px 16px;">
            ...
            <div>            <div>            <div>
                ...
                <select id="año-select" style="padding: 5px;">                <label style="font-weight: bold; margin-right: 5px;">Estado/Zona:</label>                <label style="font-weight: bold; margin-right: 5px;">Estado/Zona:</label>
                    ...
                    <?php for($i = date('Y') - 2; $i <= date('Y') + 1; $i++): ?>
                        ...
                        <option value="<?php echo e($i); ?>" <?php echo e($año == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>                <select id="estado-select" style="padding: 5px; min-width: 150px;">                <select id="estado-select" style="padding: 5px; min-width: 150px;">

                    <?php endfor; ?>

                </select>                    <option value="todos" <?php echo e($estado === 'todos' ? 'selected' : ''); ?>>Todos los Estados</option>                    <option value="todos" <?php echo e($estado === 'todos' ? 'selected' : ''); ?>>Todos los Estados</option>

            </div>

                                <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $est): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                    <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $est): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

            

            <div>                        <option value="<?php echo e($est); ?>" <?php echo e($estado === $est ? 'selected' : ''); ?>><?php echo e($est); ?></option>                        <option value="<?php echo e($est); ?>" <?php echo e($estado === $est ? 'selected' : ''); ?>><?php echo e($est); ?></option>

                <label style="font-weight: bold; margin-right: 5px;">Período:</label>

                <select id="periodo-select" style="padding: 5px;">                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <option value="segunda_quincena" <?php echo e($periodo === 'segunda_quincena' ? 'selected' : ''); ?>>            </div>            </div>
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 15px; font-size: 12px;">
            ...
            <?php $__currentLoopData = $estados_asistencia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $estado_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div style="display: flex; align-items: center; gap: 5px;">                            9 => 'Septiembre', 10 => 'Octubre', 11 => 'Noviembre', 12 => 'Diciembre'                            9 => 'Septiembre', 10 => 'Octubre', 11 => 'Noviembre', 12 => 'Diciembre'
                    ...
                    <span><?php echo e($estado_info['nombre']); ?></span>                    @endphp                    @endphp

                </div>

            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                    <?php for($i = 1; $i <= 12; $i++): ?>                    <?php for($i = 1; $i <= 12; $i++): ?>

        </div>

    </div>                        <option value="<?php echo e($i); ?>" <?php echo e($mes == $i ? 'selected' : ''); ?>>                        <option value="<?php echo e($i); ?>" <?php echo e($mes == $i ? 'selected' : ''); ?>>



                                <?php echo e($mesesEspanol[$i]); ?>                            <?php echo e($mesesEspanol[$i]); ?>
    ...
    <div style="background: #e8f4fd; padding: 10px; border-radius: 5px; margin-bottom: 20px; font-size: 14px;">
        ...
        de <?php echo e(DateTime::createFromFormat('!m', $mes)->format('F')); ?> <?php echo e($año); ?>                    <?php endfor; ?>                    <?php endfor; ?>

        <br>

        <strong>👥 Total empleados mostrados:</strong> <?php echo e($empleados->count()); ?>                </select>                </select>

        <?php if($estado !== 'todos'): ?>

            <strong> • Estado seleccionado:</strong> <?php echo e($estado); ?>            </div>            </div>
    ...
    <div style="overflow-x: auto; border: 1px solid #ddd; border-radius: 8px;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 12px;">            <div>            <div>
            ...
            <thead style="background: #447D9B; color: white; position: sticky; top: 0;">
                ...
                <tr>                <label style="font-weight: bold; margin-right: 5px;">Año:</label>                <label style="font-weight: bold; margin-right: 5px;">Año:</label>
                    ...
                    <th style="padding: 10px; border: 1px solid #ddd; min-width: 120px;">Estado</th>
                                        ...
                                        <?php for($i = date('Y') - 2; $i <= date('Y') + 1; $i++): ?>                    <?php for($i = date('Y') - 2; $i <= date('Y') + 1; $i++): ?>

                    

                    <?php $__currentLoopData = $diasDelPeriodo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                        <option value="<?php echo e($i); ?>" <?php echo e($año == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>                        <option value="<?php echo e($i); ?>" <?php echo e($año == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>

                        <th style="padding: 5px; border: 1px solid #ddd; min-width: 40px; text-align: center;">

                            <?php echo e($dia); ?>                    <?php endfor; ?>                    <?php endfor; ?>

                        </th>

                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                </select>                </select>
            ...
            <tbody>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empleado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>                    <option value="primera_quincena" <?php echo e($periodo === 'primera_quincena' ? 'selected' : ''); ?>>                    <option value="primera_quincena" <?php echo e($periodo === 'primera_quincena' ? 'selected' : ''); ?>>
                    ...
                    <tr style="border-bottom: 1px solid #eee;">
                                            ...
                                            <option value="segunda_quincena" <?php echo e($periodo === 'segunda_quincena' ? 'selected' : ''); ?>>                    <option value="segunda_quincena" <?php echo e($periodo === 'segunda_quincena' ? 'selected' : ''); ?>>

                        <td style="padding: 8px; border: 1px solid #ddd; font-weight: bold;">

                            <?php echo e($empleado->Nombre); ?> <?php echo e($empleado->Apellido_Paterno); ?> <?php echo e($empleado->Apellido_Materno); ?>                        Segunda Quincena (16-<?php echo e(cal_days_in_month(CAL_GREGORIAN, $mes, $año)); ?>)                        Segunda Quincena (16-<?php echo e(cal_days_in_month(CAL_GREGORIAN, $mes, $año)); ?>)
                        ...
                        <td style="padding: 8px; border: 1px solid #ddd;">                    </option>                    </option>
                            ...
                            <?php if($empleado->puesto && $empleado->puesto->cliente): ?>
                                ...
                                <?php echo e($empleado->puesto->cliente->Nombre); ?>                </select>                </select>
                        ...
                        <td style="padding: 8px; border: 1px solid #ddd;">
                            ...
                            <?php echo e($empleado->Estado ?? 'Sin estado'); ?>            <button id="aplicar-filtros" class="btn btn-primary" style="padding: 8px 16px;">            <button id="aplicar-filtros" class="btn btn-primary" style="padding: 8px 16px;">
                        ...
                        <?php $__currentLoopData = $diasDelPeriodo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>            </button>            </button>
                            ...
                            <td style="padding: 2px; border: 1px solid #ddd; text-align: center;">
                                ...
                                <div class="dia-asistencia <?php echo e($esDiaActual ? 'dia-actual' : ''); ?>"         
                                     ...
                                     data-dia="<?php echo e($dia); ?>"    <div style="background: #fff; padding: 15px; border-radius: 8px; margin-bottom: 20px; border: 1px solid #ddd;">    <div style="background: #fff; padding: 15px; border-radius: 8px; margin-bottom: 20px; border: 1px solid #ddd;">

                                     data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : 'NO_ASISTENCIA'); ?>"

                                     onclick="abrirModalEstados(<?php echo e($empleado->IdEmpleados); ?>, <?php echo e($dia); ?>, '<?php echo e($asistencia ? $asistencia->id : 'NO_ASISTENCIA'); ?>')"        <h4 style="margin: 0 0 10px 0; color: #333;">📌 Leyenda de Estados:</h4>        <h4 style="margin: 0 0 10px 0; color: #333;">📌 Leyenda de Estados:</h4>

                                     style="background: <?php echo e($color); ?>; 

                                            color: <?php echo e(in_array($color, ['#ffc107', '#f8d7da']) ? '#000' : '#fff'); ?>;         <div style="display: flex; flex-wrap: wrap; gap: 15px; font-size: 12px;">        <div style="display: flex; flex-wrap: wrap; gap: 15px; font-size: 12px;">
                                            ...
                                            justify-content: center;            <?php $__currentLoopData = $estados_asistencia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $estado_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>            <?php $__currentLoopData = $estados_asistencia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $estado_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     ...
                                     title="Click para seleccionar estado - Empleado: <?php echo e($empleado->IdEmpleados); ?>, Día: <?php echo e($dia); ?>, Asistencia: <?php echo e($asistencia ? $asistencia->id : 'Sin crear'); ?>">                    <span style="background: <?php echo e($estado_info['color']); ?>; color: white; padding: 2px 6px; border-radius: 3px; font-weight: bold;">                    <span style="background: <?php echo e($estado_info['color']); ?>; color: white; padding: 2px 6px; border-radius: 3px; font-weight: bold;">

                                    <?php echo e($icono ?: '?'); ?>


                                </div>                        <?php echo e($estado_info['icono']); ?>                        <?php echo e($estado_info['icono']); ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                    </span>                    </span>
                                            ...
                                            <span><?php echo e($estado_info['nombre']); ?></span>                    <span><?php echo e($estado_info['nombre']); ?></span>

                        <td style="padding: 8px; border: 1px solid #ddd; font-size: 11px; background: #f8f9fa;">

                            <?php if($asistencia && !empty($totales)): ?>                </div>                </div>

                                <div style="color: #28a745;">Asistencias: <?php echo e($totales['asistencias']); ?></div>

                                <div style="color: #dc3545;">Faltas: <?php echo e($totales['faltas']); ?></div>            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                <div style="color: #ffc107;">Retardos: <?php echo e($totales['retardos']); ?></div>

                                <?php if(isset($totales['sin_marcar']) && $totales['sin_marcar'] > 0): ?>        </div>        </div>
                        ...
                        <td style="padding: 4px; border: 1px solid #ddd;">
                            ...
                            <input type="number"     <div style="background: #e8f4fd; padding: 10px; border-radius: 5px; margin-bottom: 20px; font-size: 14px;">    <div style="background: #e8f4fd; padding: 10px; border-radius: 5px; margin-bottom: 20px; font-size: 14px;">
                                   ...
                                   data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"        <?php echo e($periodo === 'primera_quincena' ? 'Días 1 al 15' : 'Días 16 al ' . cal_days_in_month(CAL_GREGORIAN, $mes, $año)); ?>         <?php echo e($periodo === 'primera_quincena' ? 'Días 1 al 15' : 'Días 16 al ' . cal_days_in_month(CAL_GREGORIAN, $mes, $año)); ?> 

                                   value="<?php echo e($asistencia ? $asistencia->bono : ''); ?>" 

                                   style="width: 70px; font-size: 11px;"         de <?php echo e(DateTime::createFromFormat('!m', $mes)->format('F')); ?> <?php echo e($año); ?>        de <?php echo e(DateTime::createFromFormat('!m', $mes)->format('F')); ?> <?php echo e($año); ?>
                        ...
                        <td style="padding: 4px; border: 1px solid #ddd;">
                            ...
                            <input type="number"         <strong>👥 Total empleados mostrados:</strong> <?php echo e($empleados->count()); ?>        <strong>👥 Total empleados mostrados:</strong> <?php echo e($empleados->count()); ?>


                                   class="financiero-input" 

                                   data-campo="prestamo"        <?php if($estado !== 'todos'): ?>        <?php if($estado !== 'todos'): ?>

                                   data-empleado-id="<?php echo e($empleado->IdEmpleados); ?>"

                                   data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"            <strong> • Estado seleccionado:</strong> <?php echo e($estado); ?>            <strong> • Estado seleccionado:</strong> <?php echo e($estado); ?>


                                   value="<?php echo e($asistencia ? $asistencia->prestamo : ''); ?>" 

                                   style="width: 70px; font-size: 11px;"         <?php endif; ?>        <?php endif; ?>
                        ...
                        <td style="padding: 4px; border: 1px solid #ddd;">
                            ...
                            <input type="number" 
                                   ...
                                   data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"    <div style="overflow-x: auto; border: 1px solid #ddd; border-radius: 8px;">    <div style="overflow-x: auto; border: 1px solid #ddd; border-radius: 8px;">
                        ...
                        <td style="padding: 4px; border: 1px solid #ddd;">
                            ...
                            <input type="number"                 <tr>                <tr>
                                   ...
                                   data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"                    <th style="padding: 10px; border: 1px solid #ddd; min-width: 150px;">Cliente</th>                    <th style="padding: 10px; border: 1px solid #ddd; min-width: 150px;">Cliente</th>

                                   value="<?php echo e($asistencia ? $asistencia->finiquito : ''); ?>" 
                        ...
                        <td style="padding: 4px; border: 1px solid #ddd;">
                            ...
                            <input type="text"                                         
                                   ...
                                   data-campo="observaciones"                    <?php $__currentLoopData = $diasDelPeriodo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                    <?php $__currentLoopData = $diasDelPeriodo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                   data-empleado-id="<?php echo e($empleado->IdEmpleados); ?>"

                                   data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"                        <th style="padding: 5px; border: 1px solid #ddd; min-width: 40px; text-align: center;">                        <th style="padding: 5px; border: 1px solid #ddd; min-width: 40px; text-align: center;">

                                   value="<?php echo e($asistencia ? $asistencia->observaciones : ''); ?>" 

                                   style="width: 180px; font-size: 11px;">                            <?php echo e($dia); ?>                            <?php echo e($dia); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <tr>                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                        <td colspan="<?php echo e(count($diasDelPeriodo) + 8); ?>" style="text-align: center; padding: 20px; color: #666;">
        ...
        <div id="estado-buttons" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 10px;">                    <th style="padding: 10px; border: 1px solid #ddd; min-width: 80px;">Finiquito</th>                    <th style="padding: 10px; border: 1px solid #ddd; min-width: 80px;">Finiquito</th>
            ...
            <?php $__currentLoopData = \App\Models\Asistencia::ESTADOS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $estado_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <button type="button"                     <th style="padding: 10px; border: 1px solid #ddd; min-width: 200px;">Observaciones</th>                    <th style="padding: 10px; border: 1px solid #ddd; min-width: 200px;">Observaciones</th>
                        ...
                        data-estado="<?php echo e($key); ?>"                </tr>                </tr>

                        style="background: <?php echo e($estado_info['color']); ?>; 

                               color: <?php echo e(in_array($estado_info['color'], ['#ffc107', '#f8d7da']) ? '#000' : '#fff'); ?>;             </thead>            </thead>
                               ...
                               border-radius: 5px;                <?php $__empty_1 = true; $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empleado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>                <?php $__empty_2 = true; $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empleado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
            ...
            <button type="button"                         $totales = $asistencia ? $asistencia->calcularTotales() : [];                        $totales = $asistencia ? $asistencia->calcularTotales() : [];
                    ...
                    style="background: #6c757d; 
                           ...
                           transition: all 0.2s;">                            <?php echo e($empleado->Nombre); ?> <?php echo e($empleado->Apellido_Paterno); ?> <?php echo e($empleado->Apellido_Materno); ?>                            <?php echo e($empleado->Nombre); ?> <?php echo e($empleado->Apellido_Paterno); ?> <?php echo e($empleado->Apellido_Materno); ?>
                ...
                🚫 Limpiar
                            ...
                            <?php if($empleado->puesto && $empleado->puesto->cliente): ?>                            <?php if($empleado->puesto && $empleado->puesto->cliente): ?>



<div id="reporteModal" style="display: none; position: fixed; z-index: 1000; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5);">                                <?php echo e($empleado->puesto->cliente->Nombre); ?>                                <?php echo e($empleado->puesto->cliente->Nombre); ?>
    ...
    <div style="background-color: #fefefe; margin: 5% auto; padding: 20px; border-radius: 8px; width: 90%; max-width: 500px; position: relative;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; border-bottom: 1px solid #ddd; padding-bottom: 10px;">                            <?php else: ?>                            <?php else: ?>
        ...
        <form id="reporte-form">                            <?php endif; ?>                            <?php endif; ?>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
                ...
                <div>                        </td>                        </td>
                    ...
                    <select name="año" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">                        <td style="padding: 8px; border: 1px solid #ddd;">                        <td style="padding: 8px; border: 1px solid #ddd;">
                        ...
                        <?php for($i = date('Y') - 2; $i <= date('Y') + 1; $i++): ?>
                            ...
                            <option value="<?php echo e($i); ?>" <?php echo e($año == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>                            <?php echo e($empleado->Estado ?? 'Sin estado'); ?>                            <?php echo e($empleado->Estado ?? 'Sin estado'); ?>
                ...
                <div>                                                
                    ...
                    <select name="mes" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">                                                
                        ...
                        <?php for($i = 1; $i <= 12; $i++): ?>                                $color = $asistencia ? $asistencia->getColorDia($dia) : '#f8f9fa';                                // $color = $asistencia ? $asistencia->getColorDia($dia) : '#f8f9fa';

                            <option value="<?php echo e($i); ?>" <?php echo e($mes == $i ? 'selected' : ''); ?>>

                                <?php echo e($mesesEspanol[$i]); ?>                                $icono = $asistencia ? $asistencia->getIconoDia($dia) : '';                                // $icono = $asistencia ? $asistencia->getIconoDia($dia) : '';

                            </option>

                        <?php endfor; ?>                                $esDiaActual = ($dia == $diaActual && $mes == $mes && $año == $año);                                $color = '#f8f9fa'; // Color por defecto
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">                            <td style="padding: 2px; border: 1px solid #ddd; text-align: center;">                                $esDiaActual = ($dia == $diaActual && $mes == $mes && $año == $año);
                ...
                <div>
                    ...
                    <label style="display: block; margin-bottom: 5px; font-weight: bold;">Período:</label>                                <div class="dia-asistencia <?php echo e($esDiaActual ? 'dia-actual' : ''); ?>"                             @endphp

                    <select name="periodo" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">

                        <option value="primera_quincena">Primera Quincena (1-15)</option>                                     data-empleado="<?php echo e($empleado->IdEmpleados); ?>"                             <td style="padding: 2px; border: 1px solid #ddd; text-align: center;">

                        <option value="segunda_quincena">Segunda Quincena (16-30/31)</option>

                    </select>                                     data-dia="<?php echo e($dia); ?>"                                <div class="dia-asistencia <?php echo e($esDiaActual ? 'dia-actual' : ''); ?>" 

                </div>

                <div>                                     data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : 'NO_ASISTENCIA'); ?>"                                     data-empleado="<?php echo e($empleado->IdEmpleados); ?>" 

                    <label style="display: block; margin-bottom: 5px; font-weight: bold;">Estado:</label>

                    <select name="estado" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">                                     onclick="abrirModalEstados(<?php echo e($empleado->IdEmpleados); ?>, <?php echo e($dia); ?>, '<?php echo e($asistencia ? $asistencia->id : 'NO_ASISTENCIA'); ?>')"                                     data-dia="<?php echo e($dia); ?>"

                        <option value="todos">Todos los Estados</option>

                        <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $est): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                     style="background: <?php echo e($color); ?>;                                      data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : 'NO_ASISTENCIA'); ?>"

                            <option value="<?php echo e($est); ?>"><?php echo e($est); ?></option>

                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                            color: <?php echo e(in_array($color, ['#ffc107', '#f8d7da']) ? '#000' : '#fff'); ?>;                                      onclick="abrirModalEstadosDirecto(<?php echo e($empleado->IdEmpleados); ?>, <?php echo e($dia); ?>, '<?php echo e($asistencia ? $asistencia->id : 'NO_ASISTENCIA'); ?>')"

                    </select>

                </div>                                            padding: 5px;                                      style="background: <?php echo e($color); ?>; 

            </div>

            <div style="margin-bottom: 20px;">                                            border-radius: 3px;                                             color: <?php echo e(in_array($color, ['#ffc107', '#f8d7da']) ? '#000' : '#fff'); ?>; 
...
<style>                                     title="Click para seleccionar estado - Empleado: <?php echo e($empleado->IdEmpleados); ?>, Día: <?php echo e($dia); ?>, Asistencia: <?php echo e($asistencia ? $asistencia->id : 'Sin crear'); ?>">                                            user-select: none;

.dia-asistencia:hover {

    opacity: 0.8;                                    <?php echo e($icono ?: '?'); ?>                                            position: relative;
...
.financiero-input {                            </td>                                     title="Click para seleccionar estado - Empleado: <?php echo e($empleado->IdEmpleados); ?>, Día: <?php echo e($dia); ?>, Asistencia: <?php echo e($asistencia ? $asistencia->id : 'Sin crear'); ?>">

    border: 1px solid #ddd;

    padding: 2px 4px;                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                    <?php echo e($icono ?: '?'); ?>
...
.financiero-input:focus {                                                    </td>

    border-color: #007bff;

    outline: none;                        <td style="padding: 8px; border: 1px solid #ddd; font-size: 11px; background: #f8f9fa;">                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
.estado-btn:hover {
    ...
    opacity: 0.8;                                <div style="color: #28a745;">Asistencias: <?php echo e($totales['asistencias']); ?></div>                        

    transform: scale(1.02);

}                                <div style="color: #dc3545;">Faltas: <?php echo e($totales['faltas']); ?></div>                        <td style="padding: 8px; border: 1px solid #ddd; font-size: 10px;">



/* Estilos para los modales */                                <div style="color: #ffc107;">Retardos: <?php echo e($totales['retardos']); ?></div>                            <?php if($asistencia && !empty($totales)): ?>

#estadoModal, #reporteModal {

    animation: fadeIn 0.3s ease-in-out;                                <?php if(isset($totales['sin_marcar']) && $totales['sin_marcar'] > 0): ?>                                <?php $__currentLoopData = \App\Models\Asistencia::ESTADOS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $estado_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

}

                                    <div style="color: #6c757d;">Sin marcar: <?php echo e($totales['sin_marcar']); ?></div>                                    <?php if(($totales[$key] ?? 0) > 0): ?>

@keyframes fadeIn {

    from { opacity: 0; }                                <?php endif; ?>                                        <div style="color: <?php echo e($estado_info['color']); ?>; font-weight: bold;">

    to { opacity: 1; }

}                            <?php endif; ?>                                            <?php echo e($estado_info['icono']); ?>: <?php echo e($totales[$key]); ?>
...
@keyframes slideIn {                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

    from { transform: translateY(-50px); opacity: 0; }

    to { transform: translateY(0); opacity: 1; }                        <td style="padding: 4px; border: 1px solid #ddd;">                                <?php if(($totales['sin_marcar'] ?? 0) > 0): ?>

}

                            <input type="number"                                     <div style="color: #6c757d;">Sin marcar: <?php echo e($totales['sin_marcar']); ?></div>

/* Animación para el día actual */

@keyframes blink {                                   class="financiero-input"                                 <?php endif; ?>

    0%, 50% { opacity: 1; }

    51%, 100% { opacity: 0.3; }                                   data-campo="bono"                            <?php endif; ?>

}

                                   data-empleado-id="<?php echo e($empleado->IdEmpleados); ?>"                        </td>

.dia-actual {

    animation: blink 2s infinite;                                   data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"                        

    border: 2px solid #007bff !important;

    box-shadow: 0 0 10px rgba(0, 123, 255, 0.5);                                   value="<?php echo e($asistencia ? $asistencia->bono : ''); ?>"                         
                                   ...
                                   step="0.01" min="0">                            <input type="number" 
...
console.log('🚀 JavaScript de asistencia v3.1 cargado');
                            ...
                            <input type="number"                                    data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"

// Variables globales

let empleadoActual = null;                                   class="financiero-input"                                    value="<?php echo e($asistencia ? $asistencia->bono : ''); ?>" 
...
// ========== FUNCIONES PRINCIPALES ==========                                   data-empleado-id="<?php echo e($empleado->IdEmpleados); ?>"                                   step="0.01" min="0">



// 1. Aplicar filtros (funcional)                                   data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"                        </td>

function aplicarFiltros() {

    console.log('🔍 Aplicando filtros...');                                   value="<?php echo e($asistencia ? $asistencia->prestamo : ''); ?>"                         <td style="padding: 4px; border: 1px solid #ddd;">
    ...
    if (!estado || !mes || !año || !periodo) {
        ...
        console.error('❌ ERROR: Algunos elementos de filtro no se encontraron');                        <td style="padding: 4px; border: 1px solid #ddd;">                                   data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"

        return;

    }                            <input type="number"                                    value="<?php echo e($asistencia ? $asistencia->prestamo : ''); ?>" 
    ...
    const filtros = {                                   class="financiero-input"                                    style="width: 70px; font-size: 11px;" 
        ...
        periodo: periodo.value                                   data-empleado-id="<?php echo e($empleado->IdEmpleados); ?>"                        </td>

    };

                                       data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"                        <td style="padding: 4px; border: 1px solid #ddd;">

    console.log('📊 Filtros:', filtros);

                                       value="<?php echo e($asistencia ? $asistencia->fonacot : ''); ?>"                             <input type="number" 
    ...
    }                        </td>                                   data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"

    

    // Aplicar filtros redirigiendo                        <td style="padding: 4px; border: 1px solid #ddd;">                                   value="<?php echo e($asistencia ? $asistencia->fonacot : ''); ?>" 
...
function abrirModalEstados(empleadoId, dia, asistenciaId) {                                   data-campo="finiquito"                        </td>
    ...
    console.log('📋 Abriendo modal de estados:', {empleadoId, dia, asistenciaId});
                                       ...
                                       data-empleado-id="<?php echo e($empleado->IdEmpleados); ?>"                        <td style="padding: 4px; border: 1px solid #ddd;">

    // Guardar datos actuales

    empleadoActual = empleadoId;                                   data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"                            <input type="number" 

    diaActual = dia;

    asistenciaIdActual = asistenciaId;                                   value="<?php echo e($asistencia ? $asistencia->finiquito : ''); ?>"                                    class="form-control financiero-input" 
    ...
    if (modal) {                                   step="0.01" min="0">                                   data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"

        modal.style.display = 'block';

        console.log('✅ Modal mostrado');                        </td>                                   value="<?php echo e($asistencia ? $asistencia->estatus_finiquito : ''); ?>" 
...
function seleccionarEstado(estado) {
    ...
    if (!empleadoActual || !diaActual) {                                   data-empleado-id="<?php echo e($empleado->IdEmpleados); ?>"                            <input type="text" 

        console.error('❌ ERROR: No hay empleado o día seleccionado');

        return;                                   data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"                                   class="form-control financiero-input" 

    }

                                       value="<?php echo e($asistencia ? $asistencia->observaciones : ''); ?>"                                    data-campo="observaciones"

    // Mostrar loading en modal

    const botones = document.querySelectorAll('.estado-btn');                                   style="width: 180px; font-size: 11px;">                                   data-asistencia-id="<?php echo e($asistencia ? $asistencia->id : ''); ?>"

    botones.forEach(btn => {

        btn.disabled = true;                        </td>                                   value="<?php echo e($asistencia ? $asistencia->observaciones : ''); ?>" 
    ...
    // Hacer petición AJAX                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>                                   maxlength="180"
    ...
    fetch('/asistencia/guardar', {
        ...
        headers: {
            ...
            'Content-Type': 'application/json',                        <td colspan="<?php echo e(count($diasDelPeriodo) + 8); ?>" style="text-align: center; padding: 20px; color: #666;">                        </td>
        ...
        body: JSON.stringify({
            ...
            empleado_id: empleadoActual,                        </td>                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            mes: <?php echo e($mes); ?>                <?php endif; ?>                        <td colspan="<?php echo e(count($diasDelPeriodo) + 8); ?>" style="padding: 20px; text-align: center; color: #666;">

        })

    })            </tbody>                            No se encontraron empleados activos<?php echo e($estado !== 'todos' ? ' para el estado: ' . $estado : ''); ?>
    ...
    .then(data => {        </table>                        </td>
        ...
        if (data.success) {
            ...
            // Actualizar la casilla visualmente</div>                <?php endif; ?>
    ...
    .finally(() => {
        ...
        // Restaurar botones            <h3 style="margin: 0;">📅 Seleccionar Estado de Asistencia</h3>
...
// 4. Actualizar casilla en pantalla            <?php $__currentLoopData = \App\Models\Asistencia::ESTADOS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $estado_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>            <h3 style="margin: 0;">📅 Seleccionar Estado de Asistencia</h3>
...
function actualizarCasillaEnPantalla(empleadoId, dia, estado) {
    ...
    if (casilla) {
        ...
        const estados = <?php echo json_encode(\App\Models\Asistencia::ESTADOS, 15, 512) ?>;

        const estadoInfo = estados[estado] || {color: '#f8f9fa', icono: '?'};                        data-estado="<?php echo e($key); ?>"        <div id="estado-buttons" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 10px;">

        

        // Actualizar estilos                        style="background: <?php echo e($estado_info['color']); ?>;             <?php $__currentLoopData = \App\Models\Asistencia::ESTADOS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $estado_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

        casilla.style.background = estadoInfo.color;

        casilla.style.color = ['#ffc107', '#f8d7da'].includes(estadoInfo.color) ? '#000' : '#fff';                               color: <?php echo e(in_array($estado_info['color'], ['#ffc107', '#f8d7da']) ? '#000' : '#fff'); ?>;                 <button type="button" 
    ...
    }                               padding: 10px;                         data-estado="<?php echo e($key); ?>"

}

                               font-weight: bold;                        onclick="seleccionarEstadoDirecto('<?php echo e($key); ?>')"

// 5. Cerrar modal de estados

function cerrarModalEstados() {                               border-radius: 5px;                        style="background: <?php echo e($estado_info['color']); ?>; 

    const modal = document.getElementById('estadoModal');

    if (modal) {                               cursor: pointer;                               color: <?php echo e(in_array($estado_info['color'], ['#ffc107', '#f8d7da']) ? '#000' : '#fff'); ?>; 
        ...
        asistenciaIdActual = null;                    <?php echo e($estado_info['icono']); ?> <?php echo e($estado_info['nombre']); ?>                               padding: 10px; 
        ...
        console.log('❌ Modal cerrado');
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                               border-radius: 5px;
...
function abrirModalReportes() {            <button type="button"                                cursor: pointer;
    ...
    if (modal) {
        ...
        modal.style.display = 'block';                    data-estado=""                    <?php echo e($estado_info['icono']); ?> <?php echo e($estado_info['nombre']); ?>
...
}                           color: #fff;             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
function descargarReporte() {                           transition: all 0.2s;">                           color: #fff; 
    ...
    console.log('📊 Parámetros del reporte:', params);                🚫 Limpiar
    ...
    setTimeout(() => {
        ...
        if (btn) {                    <select name="año" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">            <button id="cerrar-reporte-modal" onclick="cerrarReporteModalDirecto()" style="background: none; border: none; font-size: 24px; cursor: pointer; color: #999;">&times;</button>
            ...
            btn.disabled = false;                        <?php for($i = date('Y') - 2; $i <= date('Y') + 1; $i++): ?>        </div>

        }

        cerrarModalReportes();                            <option value="<?php echo e($i); ?>" <?php echo e($año == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>        <form id="reporte-form">

        console.log('✅ Reporte descargado');

    }, 1000);                        <?php endfor; ?>            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
...
function guardarAsistencia() {                </div>                    <label style="display: block; margin-bottom: 5px; font-weight: bold;">Año:</label>
    ...
    if (btn) {                    <label style="display: block; margin-bottom: 5px; font-weight: bold;">Mes:</label>                        <?php for($i = date('Y') - 2; $i <= date('Y') + 1; $i++): ?>

        btn.innerHTML = '⏳ Guardando...';

        btn.disabled = true;                    <select name="mes" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">                            <option value="<?php echo e($i); ?>" <?php echo e($año == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const btnReporte = document.getElementById('generar-reporte');                    </select>                        ?>

    if (btnReporte) {

        btnReporte.addEventListener('click', abrirModalReportes);                </div>                        <?php for($i = 1; $i <= 12; $i++): ?>

        console.log('✅ Reporte configurado');

    }            </div>                            <option value="<?php echo e($i); ?>" <?php echo e($mes == $i ? 'selected' : ''); ?>>

    

    // Botón guardar asistencia            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">                                <?php echo e($mesesEspanol[$i]); ?>
    ...
    if (btnGuardar) {                <div>                            </option>
        ...
        console.log('✅ Guardar configurado');                    <label style="display: block; margin-bottom: 5px; font-weight: bold;">Período:</label>                        <?php endfor; ?>
    ...
    if (btnDescargarReporte) {                        <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $est): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                    </select>

        btnDescargarReporte.addEventListener('click', descargarReporte);

    }                            <option value="<?php echo e($est); ?>"><?php echo e($est); ?></option>                </div>

    

    // Botones de estado en modal                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                <div>
    ...
    botonesEstado.forEach(btn => {                    </select>                    <label style="display: block; margin-bottom: 5px; font-weight: bold;">Estado:</label>
        ...
        btn.addEventListener('click', function() {
            ...
            seleccionarEstado(estado);
                ...
                <div style="margin-bottom: 20px;">                        <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $est): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

    console.log('✅ Todos los eventos configurados');

});                <label style="display: block; margin-bottom: 10px; font-weight: bold;">Formato:</label>                            <option value="<?php echo e($est); ?>"><?php echo e($est); ?></option>



// Cerrar modales al hacer clic fuera                <div>                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
console.log('🎯 JavaScript de asistencia v3.1 configurado completamente');                    </label>                <div>
            ...
            <div style="display: flex; gap: 10px; justify-content: flex-end;">                    </label>
                ...
                <button type="button" onclick="descargarReporteConfirmado()" style="padding: 10px 20px; background: #17a2b8; color: white; border: none; border-radius: 4px; cursor: pointer;">📥 Descargar Reporte</button>
...
<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">    box-shadow: 0 0 10px rgba(0, 123, 255, 0.5);
...
function seleccionarEstado(estado) {        empleado: empleadoActual,
    ...
    fetch('/asistencia/guardar', {    const modal = document.getElementById('estadoModal');
        ...
        body: JSON.stringify({    }
            ...
            año: <?php echo e($año); ?>,function descargarReporteDirecto() {

            mes: <?php echo e($mes); ?>    alert('⚠️ FUNCIÓN REPORTE EJECUTADA');
...
document.addEventListener('DOMContentLoaded', function() {        casilla.onclick = function() {
    ...
    const btnDescargarReporte = document.getElementById('descargar-reporte');            <?php $__currentLoopData = \App\Models\Asistencia::ESTADOS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $estado_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    // Botones de estado en modal                        style="background: <?php echo e($estado_info['color']); ?>; 

    const botonesEstado = document.querySelectorAll('.estado-btn');                               color: <?php echo e(in_array($estado_info['color'], ['#ffc107', '#f8d7da']) ? '#000' : '#fff'); ?>; 
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
                <div>
                    ...
                    <select name="año" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
                        <?php for($i = date('Y') - 2; $i <= date('Y') + 1; $i++): ?>
                            <option value="<?php echo e($i); ?>" <?php echo e($año == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>
                        <?php endfor; ?>
                    </select>
                </div>
                <div>
...
</script><?php /**PATH C:\xampp\htdocs\Prestige\resources\views/asistencia/asistencia.blade.php ENDPATH**/ ?>