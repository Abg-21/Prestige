<div style="width: 100%; max-width: 800px; margin: 40px auto; background: #fff; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); padding: 32px;">
    ...
    <form id="form-crear-cliente" action="<?php echo e(route('clientes.store')); ?>" method="POST" style="width: 100%;">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="margin-bottom: 28px;">
            ...
            <textarea 
                ...
                id="Descripcion" 
                class="form-control"
                style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 6px; min-height: 100px; font-size: 15px; resize: vertical;"><?php echo e(old('Descripcion')); ?></textarea>
...
<?php /**PATH C:\xampp\htdocs\Prestige\resources\views/clientes/create_cliente.blade.php ENDPATH**/ ?>